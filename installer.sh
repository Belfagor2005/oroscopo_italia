...
changelog='\nInit Plugin'
##############################################################
TMPPATH=/tmp/oroscopo_radioitalia-main
...
wget --no-check-certificate 'https://github.com/Belfagor2005/oroscopo_radioitalia/archive/refs/heads/main.tar.gz' -O main.tar.gz
tar -xzf main.tar.gz
cp -r oroscopo_radioitalia-main/usr/ /
...
# Identify the box type and distro from files
